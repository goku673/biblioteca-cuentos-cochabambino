export const provinces = [
        ...
        images: ["/images/provincia-cercado.webp"]
    },
        {
          id  : 2,
          province : "Ayopaya",
          ...
          images : ["/images/provincia-ayopaya.webp"]
        },
        {
            id  : 3,
            province : "Tapacari",
            ...
            images :["/images/provincia-tapacari.webp"]
        },

          {
            ...
            images : ["/images/provincia-arque.webp"]
        },
          {
            id  : 5,
            province : "Bolivar",
            ...
            images: ["/images/provincia-bolivar.webp"]
        },
          {
            id  : 6,
           ...
           Desde ese día, Isabella siguió siendo una devota de la Virgen y nunca dejó de agradecerle por el milagro que había hecho. La historia de Isabella y su abuelita se convirtió en un ejemplo de la poderosa fe en la Virgen de Urkupiña para todo el pueblo.          
            `,
            descriptionQuechua : `Quillacollo llaqtapi mamá Urkupiña sapa wata ruwakun, jinataq kay mama Urkupiñaman achkka runa raymicharinapaq chimpayta yachanku. Juk sipaku Isabela sutichasqa mama Urkupiñamanta mañakusqa, maman unquspa kaptin sanullapunampaq waqaspa mañakusqa, ñapis mamanqa nak'ayllataña kawsakusarqa. K'ayantin Jatun mamán Isabelaqta allin kallpayuq mana unquyniyuq sayarisqa, runaqa mancharikusqanku, Isabellataq nisqa: "Kay virgencitaqa yanapawan mamachayta wañuymanta ayqichin". Chay p'unchaymanta pacha Isabelaqta kawsaynin chanta jatun mamanpata wajina karqa. Kayqa riqsichiwanchik mama Urkupiña allin kallpayuq kasqanta.`,
            questions :["¿Por qué se reunían las personas del pueblo?", "¿Dónde se celebra la fiesta de la Virgen de Urkupiña?", "¿Es bueno celebrar a la Virgen de Urkupiña? ¿Por qué?"],
            questionsQuechua: ["¿Imaptintaq chay ayllumanta runa qutuchakuq kanku?", "¿Mama Urkupiña maypitaq raymichakun?", "¿Waliqchu mamá Urkupiña raymichay? Imaptin?"],
            images : ["/images/provincia-quillacollo.webp"]
        },
          {
            id  : 7,
            ...
            images : ["/images/provincia-german-jordan.webp"]
        },
          {
            id  : 8,
            province : "Punata",
           ...
           `,
            ...
            images : ["/images/provincia-punata.webp"]
          },
          {
            id  : 9,
            province : "Campero",
            ...
            images: ['/images/provincia-campero.webp']
        },

          {
           ...
           `,
            ...
            images : ["/images/provincia-jose-carrasco.webp"]
        },

          {
            ...
            images : ["/images/provincia-tiraque.webp"]
        },
          {
            id  : 12,
            province : "Mizque",
            ...
            images: ["/images/provincia-mizque.webp"]
        },
          {
            id  : 13,
            ...
            images :  ["/images/provincia-esteban-arce.webp"]
        },

          {
            id  : 14,
            province : "Chapare",
            title : "El ave nocturna",
            titleQuechua: "Tuta p'isqu",
            description : `Una vez, en la comunidad de San José, las personas vivían atemorizadas por los malos espíritus y no podían vivir tranquilas. Un niño se adentró en el bosque y encontró un ave pequeña y diferente. La cuidó, la alimentó y la vio crecer hasta hacerse grande y fuerte. Por eso, el ave regresó a la comunidad para proteger a todas las personas y ahuyentar a los malos espíritus. Desde entonces, el ave nocturna vigila y protege la comunidad.`,
            ...
            `,
            questions :["¿Cómo se llama este lugar?", "¿Por qué se le dice Tuta P'isqu?", "¿Qué aprendiste de esta historia?"],
            questionsQuechua: ["¿Imataq kay kitipta sutin?", "¿Imaptintaq tuta p'isqu sutichakun?", "¿Imatataq chay jawariymanta yachakunki?"],
            images  : ["/images/provincia-chapare.webp"]
        },
          {
            id  : 15,
            province : "Capinota",
            ...
            `,
            questions :["¿Dónde vivían las personas malas?", "¿Por qué se casaron el hombre y la mujer?", "¿Estuvo bien que los padres fueran a matar al hombre?"],
            questionsQuechua: ["¿Maypitaq chay phiña runa tiyakun?", "¿Imaptintaq chay qhariwan warmiwan ima sawarakurqanku?", "¿Waliqchu tatankuna chay qharita wañuchiq risqanku?"],
            images : ["/images/provincia-capinota.webp"]
        },
          {
            id  : 16,
            province : "Arani",
            ...
            images : ["/images/provincia-arani.webp"]
        },
];

export const getProvinceById = (id) => (
    provinces.find((province) => province.id === Number(id))
);
